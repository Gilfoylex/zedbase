...
#include "zedbase/callback_iface.h"
#include "zedbase/memory/weak_ptr.h"
#include "zedbase/type_traits.h"
...
// Member functions
#define ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(INSTANCE_TYPE, ...)            \
...
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, );
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, &);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, &&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile&&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, & noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile& noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, && noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(ClassType, volatile&& noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const&&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile&&);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const& noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile& noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const&& noexcept);
ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT(const ClassType, const volatile&& noexcept);

#undef ZEDBASE_IMPL_MEMBER_FUNCTION_TRAIT
